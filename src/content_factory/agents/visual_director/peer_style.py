...
Channel badge: **AIInfoRoom** (never SCENIUM or third-party watermarks).
...
STYLE_LOCK = (
    ...
    "Upper-right corner: AIInfoRoom channel logo badge (not SCENIUM). "
...
def build_gemini_prompt(
    *,
    ...
    parts = [
        ...
        "on the opposite side; AIInfoRoom badge top-right; rich studio depth.",
    ]
