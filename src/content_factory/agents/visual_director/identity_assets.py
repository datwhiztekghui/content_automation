...
def build_identity_capture_plan(
    ...
    return {
        ...
        "capcut_identity_recipe": [
            ...
            "AIInfoRoom badge upper-right on all generative stills",
        ],
    }
    ...
    return [
        {
            ...
            "visual_description": (
                ...
                f"Giant CapCut text overlays the panel. AIInfoRoom badge top-right."
            ),
        ...
        },
        {
            ...
            "visual_description": (
                ...
                f"showing a product UI screenshot. Text banner across the top. AIInfoRoom badge."
            ),
        ...
        },
        {
            ...
            "visual_description": (
                ...
                "fills the right side containing a real product screenshot. Top right AIInfoRoom logo."
            ),
        ...
        },
        {
            ...
            "visual_description": (
                ...
                "high contrast split, peer-channel CTR energy, AIInfoRoom badge."
            ),
